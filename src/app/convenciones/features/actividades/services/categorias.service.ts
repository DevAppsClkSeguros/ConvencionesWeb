...
export class CategoriasService {
  ...
  obtieneCategorias(): Observable<CategoriasResponse> {
    return this.http
      .get<CategoriasResponse>(
        `${AppConfig.APIREST_URL}/api/Actividades/CategoriaActividades/Listado`
      )
  ...
  obtieneCategoria(categoriaId: number): Observable<CategoriasResponse> {
    return this.http
      .get<CategoriasResponse>(
        `${AppConfig.APIREST_URL}/api/Actividades/CategoriaActividades/Detalles/${categoriaId}`
      )
      .pipe(catchError(AppConfig.handleErrors));
  }
  ...
  nuevaCategoria(categoria: Categoria): Observable<CategoriasResponse> {
    return this.http
      .post<CategoriasResponse>(
        `${AppConfig.APIREST_URL}/api/Actividades/CategoriaActividades/Nueva`,
        {
          id: categoria.id,
  ...
  actualizaCategoria(categoria: Categoria): Observable<CategoriasResponse> {
    return this.http
      .put<CategoriasResponse>(
        `${AppConfig.APIREST_URL}/api/Actividades/CategoriaActividades/Actualizar/${categoria.id}`,
        {
          id: categoria.id,
          nombre: categoria.nombre,
          activo: categoria.activo,
  ...
  eliminaCategoria(categoriaId: number): Observable<CategoriasResponse> {
    return this.http
      .delete<CategoriasResponse>(
        `${AppConfig.APIREST_URL}/api/Actividades/CategoriaActividades/Eliminar/${categoriaId}`
      )
      .pipe(catchError(AppConfig.handleErrors));
  }
}
